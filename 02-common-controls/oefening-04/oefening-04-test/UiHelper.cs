...
namespace oefening_04_test
{
    public static class UiHelper
    {
        ...
        public static RadioButton GetRadioButton(Window window, string v)
        {
            return GetAutomationElement(window, v).AsRadioButton();
        }
        ...
        public static CheckBox GetCheckBox(Window window, string v)
        {
            return GetAutomationElement(window, v).AsCheckBox();
        }
